...
(function($) {
    $(function() {
        $(window).on('load', function() {
            ...
            setTimeout(function() {
                $('.box-slidein').addClass('onn')
            }, delayMs)
        });
        $('.box-slidein').on('click', '.close', function() {
            $('.box-slidein').removeClass('onn')
        });
        var header = $('#header');
        var logoAlt = $('#logo').attr('data-logo-alt');
        var logo = $('#logo').attr('data-logo');
        $(window).scroll(function() {
            var scroll = $(window).scrollTop();
            if ($('body').hasClass('show-bnoticer')) {
                if (scroll >= 100) {
        ...
        $('.header-right .btn-search').on('click', function() {
            ...
            $('.header-right .search-wrapper').toggleClass('onn');
            setTimeout(function() {
                $('.header-right .search-wrapper input').focus().addClass('something')
            }, 600)
        });
        $('#mkclVideo').on('shown.bs.modal', function() {
            $('#mkclVideo').data('bs.modal').$backdrop.addClass('backdrop-white')
        });
        $('#mkclVideo').on('hidden.bs.modal', function() {
            $('video').trigger('pause')
        });
        if ($('.navbar .navbar-toggle').css('display') == 'none') {
            $('.parallax-container .parallax').parallax()
        }
        $(window).resize(function() {
            if ($('.navbar .navbar-toggle').css('display') == 'none') {
                $('.parallax-container .parallax').removeClass('static').parallax()
            } else {
                $('.parallax-container .parallax').addClass('static')
            }
        });
        ...
        if ($(window).scrollTop() > 150) {
            $('.scroll-to-top').addClass('onn')
        }
        $(window).scroll(function() {
            if ($(this).scrollTop() > 150) {
                $('.scroll-to-top').addClass('onn')
            } else {
                $('.scroll-to-top').removeClass('onn')
            }
        });
        $('.user-testimonials .owl-carousel').owlCarousel({
            autoPlay: !0,
            stopOnHover: !0,
            singleItem: !0,
            mouseDrag: !1,
        ...
        $('.contact-holder .owl-carousel').owlCarousel({
            items: 4,
            slideSpeed: 1000,
            mouseDrag: !1,
            navigation: !0,
        ...
        $('.box-noticer-holder .btn-close').on('click', function() {
            var notice = $('.box-noticer').data('owlCarousel');
            $('body').removeClass('show-bnoticer');
            notice.destroy()
        });
        var $container = $('.grid-programs');
        $('#filter-holder li').on('click', function() {
            ...
            var selectors = [];
            $('#filter-holder li.active').each(function() {
        ...
        $(window).load(function() {
            var defaultFilter = '.enp'
            $('.grid-programs').isotope({
                filter: defaultFilter
            });
            $('.programs .sub-program-menu li[data-filter="' + defaultFilter + '"]').addClass('active')
        });
        var $holder = $('#file-box .download-wrapper');
        $('#file-box .left-menu li a, #file-box .list-labels li span').on('click', function() {
            ...
            var selectors = [];
            $('#file-box .left-menu li.active a, #file-box .list-labels li.active span').each(function() {
                selectors.push($(this).attr('data-filter'))
            });
            selector = selectors.join('');
            $holder.isotope({
        ...
        $(window).load(function() {
            $('#file-box .download-wrapper').isotope()
        });
        $('.gallery-holder .item').each(function() {
            $(this).magnificPopup({
                delegate: 'a',
                zoom: {
                    enabled: !0,
        ...
        $('.menu-holder .left-menu a').on('click', function(e) {
        ...
        $('.menu-holder').affix({
            offset: {
                top: 250,
                bottom: function() {
                    return (this.bottom = $('#footer').outerHeight(!0) + $('#footer-top').outerHeight(!0) + 30)
                }
            }
        });
        $('body').scrollspy({
        ...
        $('#btn-openings').on('click', function(e) {
            var el = $(this).attr('href');
            scrollTo(el);
            e.preventDefault()
        })
